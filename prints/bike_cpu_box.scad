...
pcbThickness        = 1.6; 
standoffHeight      = 8.0; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
standoffDiameter    = 7;
...
connectors   =
[
    [paddingFront/2, (pcbWidth+paddingRight+paddingLeft)/2, standoffHeight
     , 3.2           //-- diameter of the screw (add some slack)
     , 6             //-- the diameter of the screw head
     , 4.3           //-- the diameter of the insert
...
[
   ...
   [
     (pcbWidth+paddingLeft)-10 // from back
    ,4 // from left
    ,0 // width
    ,0 // height
    ,3.1 // radius
...
labelsPlane =
[
    [pcbLength-3, 8, 0, 1, yappBase, "Liberation Mono:style=bold", 7, "Speed"],
    [pcbLength+8, pcbWidth-8, 0, 1, yappBase, "Liberation Mono:style=bold", 7, "LED"]
];
